...
// create new ai types dynamically calling our api
import { createAiSchemaViaApi } from './src/action-types/create-ai-schema/create-ai-schema.js';
import { createAiTypeViaApi } from './src/action-types/create-ai-type/create-ai-type.js';
// create the existing deterministic static files
...
export default function (plop: NodePlopAPI) {
  ...
  installDeps(plop);
  // create a new ai schema based on calling our ai api
  createAiSchemaViaApi(plop);
  // create a new ai type based on calling our ai api
  createAiTypeViaApi(plop);
